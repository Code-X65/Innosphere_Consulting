...
>
  ...
  trackCTAConversion('Get Started', 'Homepage Hero'); }} className='mt-20 p-6 bg-[#6b9dc7] text-white font-semibold rounded-md text-md flex items-center gap-2'>
      Book A Free Consultation <ChevronRight />
       </button>
       </Link>
      </div>
